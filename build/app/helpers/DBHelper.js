...
exports.generateUpsertStatement = exports.generateUpdateStatement = exports.generateInsertValueStatement = exports.generateInsertStatement = exports.generateSelectQuery = exports.queryOne = exports.query = void 0;
...
exports.query = query;
const queryOne = (db, qry) => {
    return (0, exports.query)(db, qry)
        .then((value) => {
...
const generateSelectQuery = (table, filter = null, orderby = null, limit = null) => {
...
const generateInsertStatement = (table, obj) => {
...
const generateInsertValueStatement = (table, obj) => {
    const keys = Object.keys(obj);
    let statement = '(';
    const values = keys.map(function (key) {
        if (typeof obj[key] === 'string') {
...
exports.generateInsertValueStatement = generateInsertValueStatement;
...
const generateUpdateStatement = (table, obj, cond = '') => {
...
const generateUpsertStatement = (table, obj) => {
    ...
    let insertStmt = (0, exports.generateInsertStatement)(table, obj);
...
exports.generateUpsertStatement = generateUpsertStatement;
